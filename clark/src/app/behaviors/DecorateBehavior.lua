...
function DecorateBehavior:bind(object)
    ...
    local function updateView(object)
        ...
        updateView_(object.m_decorations)
        updateView_(object.m_decorationsMore)
    end
    ...
    local function fastUpdateView(object)
        ...
        fastUpdateView_(object.m_decorations, x, y, objectZOrder, batch, flip)
        fastUpdateView_(object.m_decorationsMore, x, y, objectZOrder, batch, flip)
    end
    ...
    local function removeView(object)
        ...
        removeView_(object.m_decorations)
        removeView_(object.m_decorationsMore)
    end
